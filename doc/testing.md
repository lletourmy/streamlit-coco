...
Before tagging (`make sync-release` / `v*`), complete the version kit under [`releases/`](releases/README.md) (e.g. [`releases/0.1.8/CHECKLIST.md`](releases/0.1.8/CHECKLIST.md)):
