...
TABLEAU_FIXTURES_DIR = REPO_ROOT / "examples" / "bi_samples" / "tableau" / "workbooks"
POWERBI_FIXTURES_DIR = REPO_ROOT / "examples" / "bi_samples" / "powerbi"
...
# remains under examples/bi_samples/tableau/workbooks/.
MIT_WORKBOOKS = (
    "ts_content.twb",
    "ts_users.twb",
)
